...
public class Complex_numbers {
    ...
    public Complex_numbers(double real, double imaginary) {
        this.real = real;
    ...
    public void add(Complex_numbers c1){
        this.real+=c1.getReal();
        this.imaginary+=c1.getImaginary();
    }
    ...
    public void substract(Complex_numbers c1){
        this.real-=c1.getReal();
        this.imaginary-=c1.getImaginary();
    }
    public static void main(String[] args){
        Complex_numbers one = new Complex_numbers(9.0, 9.0);
        Complex_numbers number = new Complex_numbers(2.5, -1.5);
        one.add(1,1);
        System.out.println("one.real= " + one.getReal());
        System.out.println("one.imaginary= " + one.getImaginary());
