...
public class Point_distance {
    ...
    public Point_distance(int x, int y) {
        this.setX(x);
        this.setY(y);
    }
    ...
    public double distance(Point_distance xy) //xy object reference is created and has all the object values which are passed
    {
    ...
    public static void main(String[] args){
        ...
        Point_distance first = new Point_distance(6, 5);
        Point_distance second = new Point_distance(3, 1);
        System.out.println("distance(0,0)= " + first.distance());
        System.out.println("distance(second)= " + first.distance(second));
        System.out.println("distance(2,2)= " + first.distance(2, 2)); //We are passing the object as parameter
        Point_distance Point = new Point_distance();
        System.out.println("distance()= " + Point.distance());
    }
}
